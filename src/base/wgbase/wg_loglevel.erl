...
wg_logger_src(Loglevel) ->
    ...
    case application:get_env(kernel, error_logger) of
        {ok, {file, File}} when is_list(File) ->
            {"", ""};
        _ ->
            {"unicode:characters_to_list(list_to_binary(", "))"}
    end,
    "-module(wg_logger).
    -author('songze.me@gmail.com').
